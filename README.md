...
4. Remove Duplicates from Sorted Array L-26 <mark>Two Pointer</mark>
5. Left Rotate an array by one place and kth place
6. Right rotate an array by kth position
7. Rotate an array L-189 <mark>Medium</mark>
8. Move zeroes at the end <mark>Two Pointer</mark> L-283
9. Linear search
10. union of two arrays <mark>Two Pointer</mark>
